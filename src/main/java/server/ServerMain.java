...
/**
 * La classe {@code ServerMain} rappresenta il punto di ingresso del server RMI.
 * Il server crea un registro RMI e 'rebind' un'istanza dell'implementazione dell'interfaccia
 * {@code EmotSongsInterface} per permettere ai client di ottenere lo stub dell'oggetto remoto.
